...
const menuIconLineTop = document.querySelector(
...
const dropdownMenuAnchors = document.querySelectorAll(
    '.dropdown-menu a');

// DECLAR DRY FUNCTION (Don't Repeat Yourself)
...
for (let i = 0; i < dropdownMenuAnchors.length; i++) {
    dropdownMenuAnchors[i].addEventListener('click',
